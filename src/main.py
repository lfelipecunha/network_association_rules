...
trainning_data = util.get_data_from_file('../data_base/trainning_data.csv')
...
util.create_csv("../results/association_rules.csv", association_rules, ["Semester", "Hour", "level", "Conf", "Sup"], parse_association_rule)


#util.generate_random_data('test_data.csv', 20000)
test_data = util.get_data_from_file('../data_base/testing_data.csv')
print("Testing....")
accuracy = nar.validate_association_rules(test_data)

# saving accuracy
print("Saving test results...")
util.create_csv("../results/accuracy.csv", accuracy, ["Semester", "Hour", "level", "Conf[rule]", "Conf[test]", "Result"], parse_accuracy)
